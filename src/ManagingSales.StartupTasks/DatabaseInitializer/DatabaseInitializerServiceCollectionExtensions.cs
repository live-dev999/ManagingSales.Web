...
namespace ManagingSales.StartupTasks.DatabaseInitializer
{
    public static class DatabaseInitializerServiceCollectionExtensions
    {
        ...
        {
            return services.AddSingleton(serviceProvider => serviceProvider
                    .GetRequiredService<IConfiguration>()
                    .GetSection(databaseInitializerSettingsPath)
                    .Get<DatabaseInitializerSettings>())
                    .AddHostedService<DatabaseInitializerHostedService<TDbContext>>();
        }
    }
}